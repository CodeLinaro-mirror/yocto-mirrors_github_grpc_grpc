...
#ifndef GRPC_SRC_CORE_EXT_TRANSPORT_CHAOTIC_GOOD_SEND_RATE_H_
#define GRPC_SRC_CORE_EXT_TRANSPORT_CHAOTIC_GOOD_SEND_RATE_H_
...
class SendRate {
 public:
  ...
  void FinishEndpointWrite() {
    queued_bytes_.endpoint_outstanding_bytes = 0;
  }
...
#endif  // GRPC_SRC_CORE_EXT_TRANSPORT_CHAOTIC_GOOD_SEND_RATE_H_
