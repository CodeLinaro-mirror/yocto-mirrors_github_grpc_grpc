...
class TransportFlowControl final {
 public:
  ...
  bool enable_preferred_rx_crypto_frame_advertisement() const {
    return ph2_enable_rx_crypto_;
  }
  void set_enable_preferred_rx_crypto_frame_advertisement(const bool enable) {
