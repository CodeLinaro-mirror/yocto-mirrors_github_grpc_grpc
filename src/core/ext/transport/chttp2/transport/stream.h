...
class Stream : public RefCounted<Stream> {
 public:
  ...
  bool IsReceivedInitialMetadata() const {
    return did_receive_initial_metadata;
  }

  void SetReceivedInitialMetadata(bool value) {
    did_receive_initial_metadata = value;
  }

  bool IsReceivedTrailingMetadata() const {
    return did_receive_trailing_metadata;
  }

  void SetReceivedTrailingMetadata(bool value) {
    did_receive_trailing_metadata = value;
  }
