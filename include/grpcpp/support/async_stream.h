...
class ClientAsyncReader final : public ClientAsyncReaderInterface<R> {
 ...
 private:
  ...
  template <class W>
  ClientAsyncReader(grpc::ChannelInterface* channel, grpc::internal::Call call, grpc::ClientContext* context,
                    const W& request, bool start, void* tag)
      : channel_(channel), context_(context), call_(call), started_(start) {
    // TODO(ctiller): don't assert
    ABSL_CHECK(init_ops_.SendMessage(request, channel_->memory_allocator()).ok());
...
class ClientAsyncWriter final : public ClientAsyncWriterInterface<W> {
 public:
  ...
  void Write(const W& msg, grpc::WriteOptions options, void* tag) override {
    ...
    // TODO(ctiller): don't assert
    ABSL_CHECK(
        write_ops_.SendMessage(msg, options, channel_->memory_allocator()).ok());
    call_.PerformOps(&write_ops_);
  }
 ...
 private:
  ...
  template <class R>
  ClientAsyncWriter(grpc::ChannelInterface* channel, grpc::internal::Call call, grpc::ClientContext* context,
...
class ClientAsyncReaderWriter final
 ...
 private:
  ...
  ClientAsyncReaderWriter(grpc::ChannelInterface* channel, grpc::internal::Call call,
